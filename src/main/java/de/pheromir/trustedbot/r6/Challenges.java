...
public enum Challenges {
    ...
    NO_REINFORCEMENTS(op -> op.side == Side.DEFENDERS, "No Reinforcements", "You're not allowed to use any reinforcement"),
    ONE_REINFORCEMENT(op -> op.side == Side.DEFENDERS, "One Reinforcement", "You're only allowed to use one reinforcement each"),
