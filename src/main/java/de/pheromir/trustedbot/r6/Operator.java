...
public enum Operator {
    ...
    BLITZ(true, SpecialUnit.GSG9, Side.ATTACKERS, new WeaponType[0], SpecialAbilities.SHIELD, SpecialAbilities.RUSH, SpecialAbilities.TOXIC),
    ...
    BLACKBEARD(true, SpecialUnit.NAVY, Side.ATTACKERS, new WeaponType[]{ WeaponType.RIFLE, WeaponType.DMR, WeaponType.REVOLVER }, SpecialAbilities.SHIELD, SpecialAbilities.TOXIC),
    ...
    JACKAL(true, SpecialUnit.GEO, Side.ATTACKERS, new WeaponType[]{ WeaponType.RIFLE, WeaponType.SMG, WeaponType.SHOTGUN }, SpecialAbilities.MEME, SpecialAbilities.CLAYMORE, SpecialAbilities.TOXIC),
    ...
    VIGIL(true, SpecialUnit.SevenOSeven, Side.DEFENDERS, new WeaponType[]{ WeaponType.SMG, WeaponType.SHOTGUN, WeaponType.SECONDARY_SMG}, SpecialAbilities.SPAWN_PEEK),
