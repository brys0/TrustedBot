...
public enum Operator {
    ...
    GLAZ("<:glaz:698351308419235861>", true, SpecialUnit.SPETZNAS, Side.ATTACKERS, new WeaponType[] { WeaponType.DMR }, SpecialAbilities.FRAGS, SpecialAbilities.MEME),
    FUZE("<:fuze:698351308746260571>", true, SpecialUnit.SPETZNAS, Side.ATTACKERS, new WeaponType[]{ WeaponType.RIFLE, WeaponType.LMG }, SpecialAbilities.SHIELD),
    ...
    FINKA("<:finka:698351308310315129>", false, SpecialUnit.SPETZNAS /* See above */, Side.ATTACKERS, new WeaponType[]{ WeaponType.RIFLE, WeaponType.LMG, WeaponType.SHOTGUN }, SpecialAbilities.FRAGS),
    ...
    KAPKAN("<:kapkan:698351308226297918>", true, SpecialUnit.SPETZNAS, Side.DEFENDERS, new WeaponType[]{ WeaponType.SMG, WeaponType.SHOTGUN}, SpecialAbilities.C4, SpecialAbilities.TRAPS),
    TACHANKA("<:tachanka:698351308687802404>", true, SpecialUnit.SPETZNAS, Side.DEFENDERS, new WeaponType[] { WeaponType.SMG, WeaponType.SHOTGUN }, SpecialAbilities.MEME),
