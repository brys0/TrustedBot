...
/**
 * Original {@author Jasgrosh (John Grosh)}
 * <p>
 * A {@link com.jagrosh.jdautilities.menu.Menu Menu} implementation that creates
 * a organized display of emotes/emojis as buttons paired with options, and
 * below the menu reactions corresponding to each button.
 *
 * @author colamine
 */
public class ButtonMenu extends Menu {
	...
	ButtonMenu(EventWaiter waiter, Set<User> users, Set<Role> roles, long timeout, TimeUnit unit, Color color,
			String text, String description, List<String> choices, Consumer<MessageReactionAddEvent> action,
	 ...
	 * {@link net.dv8tion.jda.core.entities.Message Message} in the provided
	 ...
	 * {@link com.jagrosh.jdautilities.menu.ButtonMenu ButtonMenu}.
	 *
	 * @author John Grosh
	 */
	public static class Builder extends Menu.Builder<Builder, ButtonMenu> {
		...
		/**
		 * Builds the {@link com.jagrosh.jdautilities.menu.ButtonMenu
		 ...
		 *             <li>No action {@link java.util.function.Consumer
		 *             Consumer} was set.</li>
		...
		public ButtonMenu build() {
			...
			return new ButtonMenu(waiter, users, roles, timeout, unit, color, text, description, choices, action,
					finalAction);
		}
		...
		/**
		 * Sets the text of the {@link net.dv8tion.jda.core.entities.Message
		 * Message} to be displayed when the
		 * {@link com.jagrosh.jdautilities.menu.ButtonMenu ButtonMenu} is built.
		 *
		 * <p>
		 * This is displayed directly above the embed.
		 *
		 * @param text
		 *            The Message content to be displayed above the embed when
		 *            the ButtonMenu is built
		 * @return This builder
		 */
		 ...
		 * {@link net.dv8tion.jda.core.entities.MessageEmbed MessageEmbed}. <br>
		...
		/**
		 * Sets the {@link java.util.function.Consumer Consumer} action to
		 * perform upon selecting a button.
		 *
		 * @param action
		...
		/**
		 * Sets the {@link java.util.function.Consumer Consumer} to perform if
		 * the {@link com.jagrosh.jdautilities.menu.ButtonMenu ButtonMenu} is
		 * done, either via cancellation, a timeout, or a selection being made.
		 * <p>
		 * <p>
		 ...
		 *
		 * <p>
		 * Any non-unicode {@link net.dv8tion.jda.core.entities.Emote Emote}
		 * should be added using {@link ButtonMenu.Builder#addChoice(Emote)
		...
		/**
		 * Adds a single custom {@link net.dv8tion.jda.core.entities.Emote
		 ...
		 *
		 * <p>
		 * Any non-unicode {@link net.dv8tion.jda.core.entities.Emote Emote}s
		 * should be added using {@link ButtonMenu.Builder#addChoices(Emote...)
		...
		/**
		 * Adds custom {@link net.dv8tion.jda.core.entities.Emote Emote}s as
		 * button choices.
		 *
		 * <p>
		 * Any regular unicode emojis should be added using
		 * {@link ButtonMenu.Builder#addChoices(String...)
		 ...
		 * <p>
		 * Any non-unicode {@link net.dv8tion.jda.core.entities.Emote Emote}s
		 * should be set using {@link ButtonMenu.Builder#setChoices(Emote...)
		...
		/**
		 * Sets the {@link net.dv8tion.jda.core.entities.Emote Emote}s as button
		 * choices.
		 *
		 * <p>
		 * Any regular unicode emojis should be set using
		 * {@link ButtonMenu.Builder#setChoices(String...)
