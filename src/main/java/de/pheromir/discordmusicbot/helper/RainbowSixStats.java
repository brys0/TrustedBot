...
public class RainbowSixStats {
	...
	public RainbowSixStats(String username) {
		isValid = true;
	...
	private void requestStats() {
		JSONObject jo = Methods.httpRequest(profileStatsUrl);
		try {
	...
	private void requestSeasons() {
		JSONObject jo = Methods.httpRequest(seasonStatsUrl).getJSONObject("seasons");
		try {
