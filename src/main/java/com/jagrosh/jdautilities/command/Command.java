 ...
 * 
 * <p>
 * The internal inheritance for Commands used in JDA-Utilities is that of the
 * Command object.
 * 
 * <p>
 ...
 * abstract
 * {@link com.jagrosh.jdautilities.command.Command#execute(com.jagrosh.jdautilities.command.CommandEvent)
 ...
 * </pre>
 * 
 * Execution is with the provision of a MessageReceivedEvent-CommandClient
 * wrapper called a {@link com.jagrosh.jdautilities.command.CommandEvent
 * CommandEvent} and is performed in two steps:
 * <ul>
 * <li>{@link com.jagrosh.jdautilities.command.Command#run(CommandEvent) run} -
 * The command runs through a series of conditionals, automatically terminating
 * the command instance if one is not met, and possibly providing an error
 * response.</li>
 * 
 * <li>{@link com.jagrosh.jdautilities.command.Command#execute(CommandEvent)
 * execute} - The command, now being cleared to run, executes and performs
 * whatever lies in the abstract body method.</li>
 * </ul>
 * 
...
public abstract class Command {
	 ...
	 * the command. <br>
	 * This can perform any other checks not completed by the default
	 * conditional fields.
	 */
	...
	/**
	 * {@code true} if the command may only be used in a
	 * {@link net.dv8tion.jda.core.entities.Guild Guild}, {@code false} if it
	 * may be used in both a Guild and a DM. <br>
	 * Default {@code true}.
	 */
	 ...
	 * matching the Owners or any of the CoOwners. <br>
	 * Default {@code false}.
	 */
	...
	/**
	 * Any {@link net.dv8tion.jda.core.Permission Permission}s a Member must
	 * have to use this command. <br>
	 * These are only checked in a {@link net.dv8tion.jda.core.entities.Guild
	 * Guild} environment.
	 */
	protected Permission[] userPermissions = new Permission[0];

	/**
	 * Any {@link net.dv8tion.jda.core.Permission Permission}s the bot must have
	 * to use a command. <br>
	 * These are only checked in a {@link net.dv8tion.jda.core.entities.Guild
	 * Guild} environment.
	 */
	...
	/**
	 * The {@link com.jagrosh.jdautilities.command.Command.CooldownScope
	 * CooldownScope} of the command. This defines how far of a scope cooldowns
	 * have. <br>
	 * Default
	 * {@link com.jagrosh.jdautilities.command.Command.CooldownScope#USER
	 * CooldownScope.USER}.
	 */
	 ...
	 * {@link com.jagrosh.jdautilities.command.Command#run(CommandEvent)
	 * #run(CommandEvent)}.
	 * 
	 * @param event
	 *            The {@link com.jagrosh.jdautilities.command.CommandEvent
	 *            CommandEvent} that triggered this Command
	 */
	protected abstract void execute(CommandEvent event);

	/**
	 * Runs checks for the {@link com.jagrosh.jdautilities.command.Command
	 * Command} with the given
	 * {@link com.jagrosh.jdautilities.command.CommandEvent CommandEvent} that
	 * called it. <br>
	...
	public final void run(CommandEvent event) {
		...
		if (event.getChannelType() == ChannelType.TEXT) {
			...
			terminate(event, "Dieser Befehl kann nicht im Privatchat genutzt werden.");
			return;
		}
	 ...
	 * {@link net.dv8tion.jda.core.entities.TextChannel TextChannel} by
	 * searching the channel topic for topic tags relating to the command.
	 *
	 * <p>
	 * {-{@link com.jagrosh.jdautilities.command.Command#name name}},
	 * {-{@link com.jagrosh.jdautilities.command.Command.Category category
	 * name}}, or {-{@code all}} are valid examples of ways that this method
	 * would return {@code false} if placed in a channel topic.
	 *
	 * <p>
	 * <b>NOTE:</b>Topic tags are <b>case sensitive</b> and proper usage must be
	 * in lower case! <br>
	 * Also note that setting
	 * {@link com.jagrosh.jdautilities.command.Command#usesTopicTags
	...
	/**
	 * Gets the {@link com.jagrosh.jdautilities.command.Command#name
	...
	/**
	 * Gets the {@link com.jagrosh.jdautilities.command.Command#help
	...
	/**
	 * Gets the {@link com.jagrosh.jdautilities.command.Command#category
	...
	/**
	 * Gets the {@link com.jagrosh.jdautilities.command.Command#arguments
	 ...
	 *
	 * @return {@code true} if this Command can only be used in a Guild, else
	 *         {@code false} if it can be used outside of one
	 */
	...
	/**
	 * Gets the {@link com.jagrosh.jdautilities.command.Command#requiredRole
	...
	/**
	 * Gets the {@link com.jagrosh.jdautilities.command.Command#cooldown
	...
	/**
	 * Gets the {@link com.jagrosh.jdautilities.command.Command#userPermissions
	...
	/**
	 * Gets the {@link com.jagrosh.jdautilities.command.Command#botPermissions
	...
	/**
	 * Gets the {@link com.jagrosh.jdautilities.command.Command#aliases
	...
	/**
	 * Gets the {@link com.jagrosh.jdautilities.command.Command#children
	 ...
	 * 
	 * @return {@code true} if the command is an owner command, otherwise
	...
	/**
	 * To be used in {@link com.jagrosh.jdautilities.command.Command Command}s
	 * as a means of organizing commands into "Categories" as well as terminate
	 * command usage when the calling
	...
	public static class Category {
		 ...
		 * {@link java.util.function.Predicate}, and a failure response.
		 * 
		 * <p>
		 * The command will be terminated if
		 * {@link com.jagrosh.jdautilities.command.Command.Category#test(com.jagrosh.jdautilities.command.CommandEvent)}
	...
	/**
	 * A series of {@link java.lang.Enum Enum}s used for defining the scope size
	 * for a {@link com.jagrosh.jdautilities.command.Command Command}'s
	 * cooldown.
	 *
	 * <p>
	 * The purpose for these values is to allow easy, refined, and generally
	 * convenient keys for cooldown scopes, allowing a command to remain on
	 * cooldown for more than just the user calling it, with no unnecessary
	 * abstraction or developer input.
	 *
	 * Cooldown keys are generated via
	 * {@link com.jagrosh.jdautilities.command.Command#getCooldownKey(CommandEvent)
	 * Command#getCooldownKey(CommandEvent)} using 1-2 Snowflake ID's
	 * corresponding to the name (IE: {@code USER_CHANNEL} uses the ID's of the
	 * User and the Channel from the CommandEvent).
	 *
	 * <p>
	 * However, the issue with generalizing and generating like this is that the
	 * command may be called in a non-guild environment, causing errors
	 * internally. <br>
	 * To prevent this, all of the values that contain "{@code GUILD}" in their
	 * name default to their "{@code CHANNEL}" counterparts when commands using
	 * them are called outside of a {@link net.dv8tion.jda.core.entities.Guild
	 * Guild} environment.
	 * <ul>
	 * <li>{@link com.jagrosh.jdautilities.command.Command.CooldownScope#GUILD
	 * GUILD} defaults to
	 * {@link com.jagrosh.jdautilities.command.Command.CooldownScope#CHANNEL
	 * CHANNEL}.</li>
	 * <li>{@link com.jagrosh.jdautilities.command.Command.CooldownScope#USER_GUILD
	 * USER_GUILD} defaults to
	 * {@link com.jagrosh.jdautilities.command.Command.CooldownScope#USER_CHANNEL
	 * USER_CHANNEL}.</li>
	 * </ul>
	 *
	 ...
	 * {@link net.dv8tion.jda.bot.sharding.ShardManager ShardManager}. <br>
	 * There is no shard magic, and no guarantees for a 100% "global" cooldown,
	 * unless all shards of the bot run under the same ShardManager, and/or via
	 * some external system unrelated to JDA-Utilities.
	 *
	 * @since 1.3
	 * @author Kaidan Gustave
	 *
	 * @see com.jagrosh.jdautilities.command.Command#cooldownScope
	 *      Command.cooldownScope
	 */
	public enum CooldownScope {
		/**
		 * Applies the cooldown to the calling
		 * {@link net.dv8tion.jda.core.entities.User User} across all locations
		 * on this instance (IE: TextChannels, PrivateChannels, etc).
		 *
		 * <p>
		...
		/**
		 * Applies the cooldown to the calling
		 * {@link net.dv8tion.jda.core.entities.User User} local to the
		 * {@link net.dv8tion.jda.core.entities.MessageChannel MessageChannel}
		 * the command is called in.
		 *
		 * <p>
		...
		/**
		 * Applies the cooldown to the
		 * {@link net.dv8tion.jda.core.entities.Guild Guild} the command is
		 * called in.
		 *
		 * <p>
		 * The key for this is generated in the format
		 ...
		 * {@link com.jagrosh.jdautilities.command.Command.CooldownScope#CHANNEL
		 * CooldownScope.CHANNEL} when called in a private channel. This is done
		 * in order to prevent internal {@link java.lang.NullPointerException
		 * NullPointerException}s from being thrown while generating cooldown
		 * keys!
		 */
		 ...
		 * <p>
		 * <b>NOTE:</b> This will automatically default back to
		 * {@link com.jagrosh.jdautilities.command.Command.CooldownScope#GLOBAL
		 * CooldownScope.GLOBAL} when
		 * {@link net.dv8tion.jda.core.JDA#getShardInfo() JDA#getShardInfo()}
		 * returns {@code null}. This is done in order to prevent internal
		 * {@link java.lang.NullPointerException NullPointerException}s from
		 * being thrown while generating cooldown keys!
		 */
		SHARD("S:%d", "on this shard"),

		/**
		 * Applies the cooldown to the calling
		 * {@link net.dv8tion.jda.core.entities.User User} on the Shard the
		 * command is called on.
		 *
		 * <p>
		 * The key for this is generated in the format
		 * <ul>
		 ...
		 *
		 * <p>
		 * As this implies: the command will be unusable on the instance of JDA
		 * in all types of {@link net.dv8tion.jda.core.entities.MessageChannel
		 * MessageChannel}s until the cooldown has ended.
		 *
		 * <p>
		 * The key for this is {@code <command-name>|globally}
		 */
